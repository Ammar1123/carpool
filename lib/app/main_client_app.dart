  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        backgroundColor:
            Colors.purple, // Yellow background for the bottom navigation bar
        unselectedItemColor: Colors.white, // Black color for unselected icons
        selectedItemColor: Colors.white, // Black color for selected icons
